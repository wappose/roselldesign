...
<?php if ( 'on' == et_get_option('flexible_display_recentwork_section','on') ) { ?>
	<section id="portfolio" class="clearfix">
		<?php /*
		<h1 class="section-title"><?php esc_html_e( '»', 'Flexible' ); ?></h1>
		<span class="section-tagline"><?php esc_html_e( 'Senaste inlägg', 'Flexible' ); ?></span>

		<a href="<?php echo esc_url( et_get_option( 'flexible_more_work_url', '#' ) ); ?>" class="more"><?php esc_html_e( 'Se mer &raquo;', 'Flexible' ); ?></a>
		*/ ?>
		...
		<?php
			...
			if ( $categories ){
				echo '<ul id="et_portfolio_sort_links">';
					echo '<li class="active">' . '<a href="#" data-categories_id="all">' . __( 'Alla', 'Flexible' ) . '</a>' . '</li>';
