	...
	<div class="post-content">
		<?php 
			...
			if ( $index_postinfo ){
				...
				et_postinfo_meta( $index_postinfo, et_get_option('flexible_date_format'), esc_html__('0 comments','Flexible'), esc_html__('1 comment','Flexible'), '% ' . esc_html__('comments','Flexible'), true );
				echo '</p>';
			}
		?>
		<?php the_content(); ?>
