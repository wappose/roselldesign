	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Phone number",$themename),
                   ...
                   "std" => "",
                   "type" => "text",
				   "desc" => esc_html__("You can use this text area to display a phone number on the homepage. ",$themename)
			),
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Display Blog Section",$themename),
                   ...
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the Blog Section on the homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("More Work Link URL",$themename),
                   ...
                   "std" => '#',
                   "type" => "text",
				   "desc" => esc_html__("Place any URL here. ",$themename)
			),
			...
			array( "name" => esc_html__("Exclude categories from 'Recent Work' Section",$themename),
				   ...
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => esc_html__("Here you can choose the categories to exclude from the Recent Work Section. ",$themename),
				   "usefor" => "custom",
