		...
		<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
			<article id="post-<?php the_ID(); ?>" <?php post_class('entry clearfix'); ?>>
				...
				<div class="post-content">
					...
					<div id="et_pt_blog" class="responsive">
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<div class="et_pt_blogentry clearfix">
								...
								<p class="et_pt_blogmeta"><?php esc_html_e(' ','Flexible'); ?> <?php esc_html_e(' ','Flexible'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e(' ','Flexible'); ?> <?php the_time(et_get_option('flexible_date_format')) ?> <?php esc_html_e(' ','Flexible'); ?> <?php the_category(', ') ?> </p>
								...
								<?php if (!$et_ptemplate_blogstyle) { ?>
									...
									<a href="<?php the_permalink(); ?>" class="readmore"><span><?php esc_html_e('se mer','Flexible'); ?></span></a>
								<?php } else { ?>
									<?php
										global $more;
										$more = 0;
					...
					<?php edit_post_link(esc_attr__('','Flexible')); ?>
